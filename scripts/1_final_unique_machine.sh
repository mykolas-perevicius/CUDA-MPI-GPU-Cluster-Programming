...
# --- Script Setup ---
ROOT_DIR_1="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
# shellcheck source=scripts/common_test_utils.sh
source "$ROOT_DIR_1/scripts/common_test_utils.sh" # Source common functions
...
SESSION_ID="script1_session_${SESSION_TIMESTAMP}_${MACHINE_ID_CLEAN}"
...
# --- Header ---
echo "================================================================================"
echo "Detailed Test Script 1: Unique Machine Runner"
...
for ver_subdir in "2.1_broadcast_all" "2.2_scatter_halo"; do
  ver_tag_suffix="${ver_subdir//./_}" 
  ver_display_name_suffix="${ver_subdir//_/-}"
...
echo "================================================================================"
echo "Detailed Test Script 1 Finished. Session: $SESSION_ID"
echo "================================================================================"