Okay, here's a comprehensive `README.md` that integrates implementation-specific code details for V1-V4 and summarizes the findings from your project report.
...
For a detailed narrative, in-depth analysis, and formal presentation of these findings, please refer to the full project report: `perevicius_mykolas_cs485_final_report.pdf` (or similar).
